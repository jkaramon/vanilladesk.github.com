...
module Jekyll
  ...
  MY_URL = "http://www.vanilladesk.com"
  ...
  class SitemapGenerator < Generator
    ...
    # Returns boolean
    def excluded?(page)
      norobots =  page.data['norobots'] == true
      excluded = EXCLUDED_FILES.include?(page.name) || norobots
      puts "Excluding page '#{page.name}' from sitemap.xml" if excluded
      excluded
    end
